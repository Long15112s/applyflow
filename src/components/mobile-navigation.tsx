...
export function MobileNavigation({ label, signOutAction }: { label: string; signOutAction: () => Promise<void> }) {
  ...
  const links = [{ href: "/applications", label: "Applications", active: pathname.startsWith("/applications") && !pathname.startsWith("/applications/board") }, { href: "/applications/board", label: "Board", active: pathname.startsWith("/applications/board") }, { href: "/calendar", label: "Calendar", active: pathname.startsWith("/calendar") }, { href: "/analytics", label: "Analytics", active: pathname.startsWith("/analytics") }];
